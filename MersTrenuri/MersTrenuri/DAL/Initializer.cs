    ...
    public class Initializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<Context>
    {
        protected override void Seed(Context context)
        {
            ...
            var trenuri = new List<Tren>{
                //new Tren{ID=1, Rang="R"},    //new Tren{ID=2, Rang="R"}
            ...
            var statiiTren = new List<StatieTren> {
                ...
                new StatieTren{ TrenID = 1011, GaraID =2010,NrSt=3, OraSosire= DateTime.Parse("15:00"), OraPlecare= DateTime.Parse("15:05")},   //Cluj-Napoca
                new StatieTren{ TrenID = 1011, GaraID =2011,NrSt=4, OraSosire= DateTime.Parse("17:00"), OraPlecare= DateTime.Parse("17:05")},   //Targu Mures
                ...
                new StatieTren{ TrenID = 1012, GaraID =2010,NrSt=5, OraSosire= DateTime.Parse("09:00"), OraPlecare= DateTime.Parse("09:05")},   //Cluj-Napoca
                new StatieTren{ TrenID = 1012, GaraID =2011,NrSt=4, OraSosire= DateTime.Parse("07:00"), OraPlecare= DateTime.Parse("07:05")},   //Targu Mures
                ...
                new StatieTren{ TrenID = 1051, GaraID =2010,NrSt=1, OraSosire= DateTime.Parse("11:00"), OraPlecare= DateTime.Parse("11:05")},   //Cluj-Napoca
                new StatieTren{ TrenID = 1051, GaraID =2011,NrSt=2, OraSosire= DateTime.Parse("13:00"), OraPlecare= DateTime.Parse("13:05")},   //Targu Mures
                ...
                new StatieTren{ TrenID = 1052, GaraID =2010,NrSt=4, OraSosire= DateTime.Parse("08:00"), OraPlecare= DateTime.Parse("11:00")},   //Cluj-Napoca
                new StatieTren{ TrenID = 1052, GaraID =2011,NrSt=3, OraSosire= DateTime.Parse("06:00"), OraPlecare= DateTime.Parse("06:05")},   //Targu Mures
                ...
                new StatieTren{ TrenID = 1061, GaraID =2010, NrSt=3, OraSosire= DateTime.Parse("05:00"), OraPlecare= DateTime.Parse("05:05")},   //Cluj-Napoca
                new StatieTren{ TrenID = 1061, GaraID =2011, NrSt=4, OraSosire= DateTime.Parse("07:00"), OraPlecare= DateTime.Parse("07:05")},   //Targu Mures
                ...
                new StatieTren{ TrenID = 1062, GaraID =2010, NrSt=8, OraSosire= DateTime.Parse("10:00"), OraPlecare= DateTime.Parse("10:05")},   //Cluj-Napoca
                new StatieTren{ TrenID = 1062, GaraID =2011, NrSt=7, OraSosire= DateTime.Parse("08:00"), OraPlecare= DateTime.Parse("08:05")},   //Targu Mures
